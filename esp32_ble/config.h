...
#define WIFI_STATIC_IP_LOCAL  192,168,2,55
...
#define WIFI_STA_SSID   "Your WiFi SSID"      // WiFi SSID      (leave empty ("") to not use WiFi)
#define WIFI_STA_PSK    "Your WiFi Password"  // WiFi password  (leave empty ("") to not use WiFi)
...
#define MQTT_PREFIX     ""
#define MQTT_HOSTNAME   "192.168.1.10"  // IP or hostname (example: "192.168.1.10")
