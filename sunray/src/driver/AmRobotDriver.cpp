...
void AmMotorDriver::setMotorPwm(int leftPwm, int rightPwm, int mowPwm, bool releaseBrakesWhenZero, int rightSpeed, int leftSpeed){  
...
void AmMotorDriver::resetMotorFaults(){  
  ...
  CONSOLE.println("Starting Recovery JYQD2021 Driver. Brake-Pins and Dir-Pins are LOW for 200ms");
  delay(200);
  //Ende
}
