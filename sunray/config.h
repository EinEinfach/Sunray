...
#define TICKS_PER_REVOLUTION  384     // odometry ticks per wheel revolution (RM18)
...
#define MAX_MOW_RPM 200 // maximum value is 255
...
#define OBSTACLE_MAX_NUMBER 20  // maximum number of obstacles to store in memory (if more obstacles detected, all obstacles will be cleared)
